...
#ifndef _TAO_IDL_TYPECODES_FNR1RU_H_
#define _TAO_IDL_TYPECODES_FNR1RU_H_
...
#define _MESSAGING_EXCEPTIONHOLDER__SARG_TRAITS_
  ...
  template<>
  class SArg_Traits< ::MyModule::TypeCodeList>
    : public
